...
<script>
    function  update(routeName,staffNo,routeNo) {
        ...
        layer.open({
            ...
            , yes: function () {
                $.ajax({
                    type: "post"
                    , url: "${pageContext.request.contextPath}/route/update"
                    , dataType: 'json'
    ...
    function xrsj(url) {
        ...
        table.render({
            ...
            , height: 451
            , page: true
            , url: '${pageContext.request.contextPath}/route/'+url //数据接口
            , cellMinWidth: 182
            , cols: [[ //表头
    ...
    function del(routeNo) {
        $.ajax({
            type: "post"
            , url: "${pageContext.request.contextPath}/route/del/" + routeNo
            , dataType: 'json'
            , success: function (data) {
                layer.msg(data.msg, {time: 1000});
                if (data.code == 3) {
