...
<script>
    ...
    layui.use('table', function () {
        ...
        table2.render({
            ...
            , url: '${pageContext.request.contextPath}/dispatch/json' //数据接口
            , cols: [[ //表头
    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , url: '${pageContext.request.contextPath}/firm/json' //数据接口
            , cols: [[ //表头
                {type: 'numbers', title: '序号'}
...
<script>
    ...
    function addbm(addupda, did) {
        ...
        layer.open({
            ...
            , yes: function () {
                ...
                $.ajax({
                    type: "post"
                    , url: "${pageContext.request.contextPath}/dispatch/" + url
                    , dataType: 'json'
    ...
    function del(departNo) {
        $.ajax({
            type: "post"
            , url: "${pageContext.request.contextPath}/dispatch/del/" + departNo
            , dataType: 'json'
            , success: function (data) {
                layer.msg(data.msg, {time: 1000});
                if (data.code == 3) {
...
<script>
    ...
    function addgs(addupda, did) {
        ...
        layer.open({
            ...
            , yes: function () {
                ...
                $.ajax({
                    type: "post"
                    , url: "${pageContext.request.contextPath}/firm/" + url
                    , dataType: 'json'
                    , success: function (data) {
                        layer.msg(data.msg, {time: 1000});
                        if (data.code == 3) {
    ...
    function delgs(departNo) {
        $.ajax({
            type: "post"
            , url: "${pageContext.request.contextPath}/firm/del/" + departNo
            , dataType: 'json'
            , success: function (data) {
                layer.msg(data.msg, {time: 1000});
                if (data.code == 3) {
