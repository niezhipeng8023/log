...
<script>
    function xrsj(url) {
        table.render({
            ...
            , height: 451
            , page: true
            , url: '${pageContext.request.contextPath}/vehicle/'+url //数据接口
            , cellMinWidth: 150
            , cols: [[ //表头
    ...
    function  update(license,vType,staffNo,vload) {
        ...
        layer.open({
            ...
            , yes: function () {
                $.ajax({
                    type: "post"
                    , url: "${pageContext.request.contextPath}/vehicle/update"
                    , dataType: 'json'
    ...
    function del(license) {
        $.ajax({
            type: "post"
            , url: "${pageContext.request.contextPath}/vehicle/del/" + license
            , dataType: 'json'
            , success: function (data) {
                layer.msg(data.msg, {time: 1000});
                if (data.code == 3) {
