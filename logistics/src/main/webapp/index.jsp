            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="kitNavbar" kit-navbar>
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <a href="javascript:;" data-url="${pageContext.request.contextPath}/depart" data-icon="&#xe614;" data-title="添加员工信息"
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <a href="javascript:;" data-url="${pageContext.request.contextPath}/vehicle" data-icon="&#xe614;" data-title="添加车辆信息"
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <a href="javascript:;" data-url="${pageContext.request.contextPath}/route" data-icon="&#xe614;" data-title="添加路线信息"
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <a href="javascript:;" data-url="${pageContext.request.contextPath}/waybill" data-icon="&#xe628;" data-title="添加运单信息" kit-target
                               data-id='12'><i class="layui-icon">&#xe628;</i><span> 添加运单信息</span></a>
                        </dd>
                        <dd>
                            <a href="javascript:;" data-url="${pageContext.request.contextPath}/positions" data-icon="&#xe614;" data-title="实时运单信息"
